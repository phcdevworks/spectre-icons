...
final class ManifestRendererTest extends Spectre_Icons_PHPUnit_Test_Case {
    ...
    public function test_unknown_library_and_unknown_icon_return_empty_output(): void {
        $this->assertSame('', Spectre_Icons_Elementor_Manifest_Renderer::render_icon(array('library' => 'missing', 'value' => 'missing icon')));
        ...
        $this->assertSame(
            '',
            Spectre_Icons_Elementor_Manifest_Renderer::render_icon(array('library' => 'test-lib', 'value' => 'test-lib unknown'))
        );
    }
}

...
We pledge to make participation in the
**Spectre Icons** project a harassment-free experience for everyone, regardless of age,
...
public spaces when an individual is representing the Spectre Icons project or its
community.

## Enforcement

Project maintainers are responsible for clarifying and
enforcing this Code of Conduct. If unacceptable behavior occurs, maintainers may
...
If you experience or witness unacceptable
behavior, please report it by:

- Opening a private issue to the maintainers
- Emailing **conduct@phcdevworks.com**

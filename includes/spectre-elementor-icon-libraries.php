		...
		foreach ($definitions as $slug => $definition) {
			...
			$libraries[$slug] = [
				...
				'config'      => [
					...
					'iconType'        => 'svg',
					'native'          => false,
					'fetchJson'       => trailingslashit(SPECTRE_ELEMENTOR_ICONS_MANIFEST_URL) . ltrim($definition['manifest'], '/\\'),
					'url'             => trailingslashit(SPECTRE_ELEMENTOR_ICONS_MANIFEST_URL) . ltrim($definition['manifest'], '/\\'),
